...
*/
    ...
    function p() {
        for (var a = q, b = {}, c = 0; c < a.length; ++c)
            b[a[c]] = c;
        return b
    }
    function r() {
    ...
    var I = /:[0-9]+$/
      , L = function(a, b) {
        ...
        if ("protocol" === b || "port" === b)
            a.protocol = J(a.protocol) || J(B.location.protocol);
    ...
    function Y(a, b) {
        ...
        b = R(b, 3, c);
        z(d) && (d = U(d),
        c ? la("_gl", d, a) : Z("_gl", d, a, !1));
        !c && z(e) && (c = U(e),
        Z("_gl", c, a, !0));
        for (var f in b)
            b.hasOwnProperty(f) && ma(f, b[f], a)
    }
    function ma(a, b, c, d) {
        if (c.tagName) {
...
(function() {
    ...
    var Qa = window
      ...
      , G = function(a) {
        ...
        if (b && b.ioo && b.ioo() || Za.documentElement.hasAttribute("data-google-analytics-opt-out") || a && !0 === Qa["ga-disable-" + a])
            return !0;
        try {
            var c = Qa.external;
    ...
    var bd = function(a) {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j100", "sr=1"],
        b && a.push("_f=" + b),
    ...
    function Sa(a) {
        ...
        default:
            b ? (g = g || ua,
            "image" == b ? wc(e, ca, g) : "xhr" == b && wd(e, ca, g) || "beacon" == b && x(e, ca, g) || ba(e, ca, g)) : ba(e, ca, g)
        }
        ca = h(l);
        g = ca.hitcount;
        ca.hitcount = g ? g + 1 : 1;
      ...
      , pd = function(a) {
        ...
        if (d && a.get(cc) && (b = M.location.hash)) {
            ...
            for (l = 0; l < b.length; ++l)
                (D(b[l], "utm_id") || D(b[l], "utm_campaign") || D(b[l], "utm_source") || D(b[l], "utm_medium") || D(b[l], "utm_term") || D(b[l], "utm_content") || D(b[l], "gclid") || D(b[l], "dclid") || D(b[l], "gclsrc") || D(b[l], "wbraid")) && d.push(b[l]);
            0 < d.length && (b = "#" + d.join("&"),
            a.set(kb, a.get(kb) + b))
        }
    }
